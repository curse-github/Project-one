...
int main(int argc, char** argv) {
    ...
    , "Resources/Models/Quad.obj", "Resources/Textures/RedPane.bmp",
    {1.0f, 1.0f, 1.0f}, 1.0f);
    engine.addObject(// monkey1
        {-1.75f, -0.5f, 2.25f},// position
        {1.0f, 0.75f, 0.75f},// scale
        {0.0f, -DEG45, 0.0f}// rotation
    , "Resources/Models/suzanne.obj", "Resources/Textures/White.bmp",
    ...
    engine.addObject(// floor
        ...
        {0.0f, 0.0f, 0.0f}// rotation
    , "Resources/Models/Quad.obj", "Resources/Textures/Debug.bmp",
    {1.0f, 1.0f, 1.0f}, 1.0f);
