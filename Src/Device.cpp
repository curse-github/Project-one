...
#ifdef _DEBUG
        std::cout << "Device count: " << deviceCount << std::endl;// print number of available graphics cards
#endif
...
#ifdef _DEBUG
        std::cout << "physical device: " << properties.deviceName << std::endl;// print name of graphics card
#endif
    }
